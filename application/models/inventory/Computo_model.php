...
class Computo_model extends CI_Model
{
    ...
    $additional_data = [
      ...
      'memory_ram' => $this->input->post('memory_ram'),
      'memory_ram_max' => $this->input->post('memory_ram_max'),
      'number_slot' => $this->input->post('number_slot')
    ];
