...
/* inventory/projector/projector.twig */
class __TwigTemplate_4f4f8f1115aa93608a16a547cb0d185bf425d3b91e9d9288a0d62a845b2f1108 extends \Twig\Template
{
    ...
    {
        $this->parent = $this->loadTemplate("overall/layout.twig", "inventory/projector/projector.twig", 1);
...
\t\t\t\t\t\t\t<li class=\"breadcrumb-item active\">Proyectores</li>
\t\t\t\t\t\t</ol>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
...
\t";
        // line 80
        $this->loadTemplate("inventory/projector/add_projector.twig", "inventory/projector/projector.twig", 80)->display($context);
        // line 81
        echo "\t";
        $this->loadTemplate("inventory/projector/edit_projector.twig", "inventory/projector/projector.twig", 81)->display($context);
        // line 82
        echo "\t";
        $this->loadTemplate("inventory/projector/view_projector.twig", "inventory/projector/projector.twig", 82)->display($context);
    }
...
\t<script src=\"";
        // line 95
        echo twig_escape_filter($this->env, base_url(), "html", null, true);
        echo "custom/js/projector.js\"></script>
";
    }

    public function getTemplateName()
    {
        return "inventory/projector/projector.twig";
    }
...
\t\t\t\t<div class=\"row mb-2\">
\t\t\t\t\t<div class=\"col-sm-6\">
\t\t\t\t\t\t<h1>Proyectores{% if (acl_permits('inventory.add')) %}&nbsp;
\t\t\t\t\t\t\t<button class=\"btn btn-success btn-sm\" data-toggle=\"modal\" data-target=\"#addEquipmentModal\" onclick=\"addEquipmentModel()\">
\t\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i>
...
\t\t<!-- /.content -->
\t</div>
\t{% include 'inventory/projector/add_projector.twig' %}
\t{% include 'inventory/projector/edit_projector.twig' %}
\t{% include 'inventory/projector/view_projector.twig' %}
{% endblock %}
...
\t<!-- Custom -->
\t<script src=\"{{ base_url() }}custom/js/projector.js\"></script>
{% endblock %}
", "inventory/projector/projector.twig", "/home3/pcbtroni/cronos.pcbtroniks.com/application/views/inventory/projector/projector.twig");
    }
}
