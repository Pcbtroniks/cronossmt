...
/* inventory/otherproducts/otherproducts.twig */
class __TwigTemplate_fe031d98f4d4097e0b0b686c27a80b74c160c82634443bf1c704ab16644a9014 extends \Twig\Template
{
    ...
    {
        $this->parent = $this->loadTemplate("overall/layout.twig", "inventory/otherproducts/otherproducts.twig", 1);
...
\t";
        // line 81
        $this->loadTemplate("inventory/otherproducts/add_otherproducts.twig", "inventory/otherproducts/otherproducts.twig", 81)->display($context);
        // line 82
        echo "\t";
        $this->loadTemplate("inventory/otherproducts/edit_otherproducts.twig", "inventory/otherproducts/otherproducts.twig", 82)->display($context);
        // line 83
        echo "\t";
        $this->loadTemplate("inventory/otherproducts/view_otherproducts.twig", "inventory/otherproducts/otherproducts.twig", 83)->display($context);
    }
...
\t<script src=\"";
        // line 96
        echo twig_escape_filter($this->env, base_url(), "html", null, true);
        echo "custom/js/otherproducts.js\"></script>
";
    }

    public function getTemplateName()
    {
        return "inventory/otherproducts/otherproducts.twig";
    }
...
\t\t\t\t<div class=\"row mb-2\">
\t\t\t\t\t<div class=\"col-sm-6\">
\t\t\t\t\t\t<h1>Resto de equipos{% if (acl_permits('inventory.add')) %}&nbsp;
\t\t\t\t\t\t\t<button class=\"btn btn-success btn-sm\" data-toggle=\"modal\" data-target=\"#addEquipmentModal\" onclick=\"addEquipmentModel()\">
\t\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i>
...
\t\t<!-- /.content -->
\t</div>
\t{% include 'inventory/otherproducts/add_otherproducts.twig' %}
\t{% include 'inventory/otherproducts/edit_otherproducts.twig' %}
\t{% include 'inventory/otherproducts/view_otherproducts.twig' %}
{% endblock %}
...
\t<!-- Custom -->
\t<script src=\"{{ base_url() }}custom/js/otherproducts.js\"></script>
{% endblock %}
", "inventory/otherproducts/otherproducts.twig", "/home3/pcbtroni/cronos.pcbtroniks.com/application/views/inventory/otherproducts/otherproducts.twig");
    }
}
